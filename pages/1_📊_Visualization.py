...
if "invalid_date" not in st.session_state or st.session_state.invalid_date == False:
    ...
    summary_yield_curve_key_trends = openai_util.summarize_basic_trends(df_filtered, st.session_state.start_date, st.session_state.end_date, title, show_bps=True)
